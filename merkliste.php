...
<?php
        ...
        $sql = "SELECT b.UserID, a.ProductID, a.Fahrzeugname, a.Einsatzgebiet, a.Bild, a.Name_des_Halters, a.Telefonnummer, a.Email FROM fahrzeuge as a, liste as b WHERE b.UserID = " . $_SESSION['userid'] . " AND b.ProductID = a.ProductID";
...
?>
			...
			<div id="produkt_merkliste"><a href="del_merkliste.php?pid=<?php echo $produkt_id; ?>">Von Merkliste entfernen...</a></div>
